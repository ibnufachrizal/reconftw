...
declare -A gotools
gotools["gf"]="GO111MODULE=on go get -v github.com/tomnomnom/gf"
gotools["qsreplace"]="GO111MODULE=on go get -v github.com/tomnomnom/qsreplace"
gotools["Amass"]="GO111MODULE=on GO111MODULE=on go get -v github.com/OWASP/Amass/v3/..."
gotools["ffuf"]="GO111MODULE=on go get -u github.com/ffuf/ffuf"
gotools["assetfinder"]="GO111MODULE=on go get -v github.com/tomnomnom/assetfinder"
gotools["github-subdomains"]="GO111MODULE=on go get -u github.com/gwen001/github-subdomains"
gotools["cf-check"]="GO111MODULE=on go get -v github.com/dwisiswant0/cf-check"
gotools["waybackurls"]="GO111MODULE=on go get -v github.com/tomnomnom/hacks/waybackurls"
gotools["nuclei"]="GO111MODULE=on GO111MODULE=on go get -v github.com/projectdiscovery/nuclei/v2/cmd/nuclei"
gotools["anew"]="GO111MODULE=on go get -v github.com/tomnomnom/anew"
gotools["notify"]="GO111MODULE=on GO111MODULE=on go get -v github.com/projectdiscovery/notify/cmd/notify"
gotools["mildew"]="GO111MODULE=on go get -u github.com/daehee/mildew/cmd/mildew"
gotools["dirdar"]="GO111MODULE=on go get -u github.com/m4dm0e/dirdar"
gotools["unfurl"]="GO111MODULE=on go get -v github.com/tomnomnom/unfurl"
gotools["httpx"]="GO111MODULE=on GO111MODULE=on go get -v github.com/projectdiscovery/httpx/cmd/httpx"
gotools["github-endpoints"]="GO111MODULE=on go get -u github.com/gwen001/github-endpoints"
gotools["dnsx"]="GO111MODULE=on GO111MODULE=on go get -v github.com/projectdiscovery/dnsx/cmd/dnsx"
gotools["subfinder"]="GO111MODULE=on GO111MODULE=on go get -v github.com/projectdiscovery/subfinder/v2/cmd/subfinder"
gotools["gau"]="GO111MODULE=on go get -v github.com/lc/gau"
gotools["subjs"]="GO111MODULE=on GO111MODULE=on go get -u -v github.com/lc/subjs"
gotools["Gxss"]="GO111MODULE=on go get -v github.com/KathanP19/Gxss"
gotools["shuffledns"]="GO111MODULE=on GO111MODULE=on go get -v github.com/projectdiscovery/shuffledns/cmd/shuffledns"
gotools["gospider"]="GO111MODULE=on go get -u github.com/jaeles-project/gospider"
gotools["crobat"]="GO111MODULE=on go get -v github.com/cgboal/sonarsearch/crobat"
gotools["crlfuzz"]="GO111MODULE=on GO111MODULE=on go get -v github.com/dwisiswant0/crlfuzz/cmd/crlfuzz"
